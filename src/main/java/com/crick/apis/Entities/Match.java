...
public class Match {
    ...
    public Match(Long matchId, String teamHeading, String matchNumberVenue, String battingTeam, String battingTeamScore, String bowlTeam, String bowlTeamScore, String liveText, String matchLink, String textComplete, MatchStatus status, Date date) {
    ...
    public void setMatchStatus(){
        if(textComplete.isBlank()){
            ...
            this.status=MatchStatus.COMPLELTED;
        }
    }
